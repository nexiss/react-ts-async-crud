          ...
          <Item>
            ...
            >
              ...
              <p>
                ...
                <strong>Add/Remove</strong>&nbsp;actions will trigger an extra
                fetch if they success.
              </p>
              <p>
                If parallel requests are triggered, progress bar will remain
                displayed since the first request is triggered until the last
                one has finished
              </p>
              <p>
                You can open the console to see how actions are performed under
                the hood
              </p>
              <StateComponent
                settings={settings}
